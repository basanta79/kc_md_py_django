...
from blogs.api import BlogListApi, PostListView, PostListModelView, PostDetailView, PostListView2
...
urlpatterns = [
    ...
    path('api/v1/post/', PostListView2.as_view(), name='api-post-list-2'),
